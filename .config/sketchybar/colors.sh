...
# -- Catppuccin Scheme -- 
export BAR_COLOR=0xff181926        # Dark navy from background
export ITEM_BG_COLOR=0xff1e2030    # Slightly lighter navy for items
export ACCENT_COLOR=0xffcdd6f4     # Brighter light blue for better contrast
